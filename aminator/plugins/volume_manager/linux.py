...
"""
aminator.plugins.volume_manager.linux
================================
basic linux volume manager
"""
import logging
import os
import re
...
from aminator.plugins.base import BaseVolumeManagerPlugin
...
class LinuxVolumeManager(BaseVolumeManagerPlugin):
    """
    ...
    def __call__(self, device_manager):
